...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-pcs-cycling-stats-dev-key-change-in-production')
...
LOGGING = {
    ...
    'loggers': {
        ...
        'riders': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
        'races': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
        'teams': {'handlers': ['console'], 'level': 'DEBUG', 'propagate': False},
    },
}
